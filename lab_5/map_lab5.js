...
var christPopup = "Chirst the Redeemer<br/><img src='https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Aerial_view_of_the_Statue_of_Christ_the_Redeemer.jpg/256px-Aerial_view_of_the_Statue_of_Christ_the_Redeemer.jpg' alt='Christ the Redeemer Wiki' width='150px'/>";
...
//Add scalebar
var scalebar = L.control.scale({position: 'bottomright', maxWidth: '150', metric: 'True'});
scalebar.addTo(mymap);
...
var chirst = L.marker([-22.951728275037908, -43.210412100446604]).bindPopup(christPopup, customOptions).addTo(landmarks);
...
//Update the lat/long based on update reading
